...
namespace Spekt.TestLogger.JUnit
{
    ...
    internal sealed class JUnitReporterCommandLineOptionsProvider : ICommandLineOptionsProvider
    {
        public const string ReportJUnitOption = "report-junit";
        public const string ReportJUnitFileNameOption = "report-junit-filename";

        private readonly JUnitTestReporterExtension extension;
        ...
        public IReadOnlyCollection<CommandLineOption> GetCommandLineOptions()
        {
            return
            [
                new CommandLineOption(ReportJUnitOption, "Enable generating JUnit test report", ArgumentArity.Zero, isHidden: false),
                new CommandLineOption(ReportJUnitFileNameOption, "The name of the generated JUnit test report", ArgumentArity.ExactlyOne, isHidden: false),
            ];
        }
