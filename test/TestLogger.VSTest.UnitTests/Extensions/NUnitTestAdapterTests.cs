...
namespace Spekt.TestLogger.UnitTests.Extensions
{
    ...
    public class NUnitTestAdapterTests
    {
        ...
        {
            var builder = new TestResultInfoBuilder(DummyNamespace, DummyType, DummyMethod)
            ...
            var modifiedResults = this.adapter.TransformResults(results, new(), builder.TestCase);
